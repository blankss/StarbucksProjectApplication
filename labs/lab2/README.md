...
**a.** The Lombok Annonation or Feature being tested <br/>
In this case, the code specifies generating the getter and setter methods for the private instance   variable _userName_ and only a getter method for the private instance variable _userAge_.
**b.** How does the Output verify your understanding of the Feature being tested? <br />
...
**b.** How does the Output verify your understanding of the Feature being tested? <br />
   From the output, we see that there are getter and setter methods for userId
